...
Later on docker images were build and run in gcloud as part of our continuous integration pipeline as each time a push or pull request was made a new container image for training and prediction was build in the cloud.
 ---
